...
#define NODE_MAIN_LOGGER_NAME "dp_adapt_backs_controller_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdp_adapt_backs_controller_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<DPAdaptBacksControllerNode>";
