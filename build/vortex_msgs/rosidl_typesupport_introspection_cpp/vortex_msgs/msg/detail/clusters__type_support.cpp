...
{
  new (message_memory) vortex_msgs::msg::Clusters(_init);
}

void Clusters_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vortex_msgs::msg::Clusters *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Clusters_message_member_array[3] = {
  {
    ...
    offsetof(vortex_msgs::msg::Clusters, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vortex_msgs::msg::Clusters, centroids),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vortex_msgs::msg::Clusters, clusters),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__Clusters__clusters,  // fetch(index, &value) function pointer
    assign_function__Clusters__clusters,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Clusters_message_members = {
  ...
  3,  // number of fields
  sizeof(vortex_msgs::msg::Clusters),
...
{
  return &::vortex_msgs::msg::rosidl_typesupport_introspection_cpp::Clusters_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vortex_msgs, msg, Clusters)() {
  return &::vortex_msgs::msg::rosidl_typesupport_introspection_cpp::Clusters_message_type_support_handle;
}
