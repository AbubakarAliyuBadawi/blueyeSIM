...
bool vortex_msgs__msg__parameter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vortex_msgs.msg._parameter.Parameter", full_classname_dest, 36) == 0);
  }
  vortex_msgs__msg__Parameter * ros_message = _ros_message;
  {  // name
...
PyObject * vortex_msgs__msg__parameter__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vortex_msgs.msg._parameter");
