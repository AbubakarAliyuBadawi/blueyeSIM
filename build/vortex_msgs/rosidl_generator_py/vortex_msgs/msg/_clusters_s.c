...
bool vortex_msgs__msg__clusters__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vortex_msgs.msg._clusters.Clusters", full_classname_dest, 34) == 0);
  }
  vortex_msgs__msg__Clusters * ros_message = _ros_message;
  {  // header
  ...
  {  // centroids
    ...
    if (!sensor_msgs__msg__point_cloud2__convert_from_py(field, &ros_message->centroids)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // clusters
    ...
    sensor_msgs__msg__PointCloud2 * dest = ros_message->clusters.data;
...
PyObject * vortex_msgs__msg__clusters__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vortex_msgs.msg._clusters");
  ...
  {  // centroids
    PyObject * field = NULL;
    field = sensor_msgs__msg__point_cloud2__convert_to_py(&ros_message->centroids);
    if (!field) {
      return NULL;
    }
    {
