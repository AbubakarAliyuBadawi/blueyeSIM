...
bool vortex_msgs__msg__waypoints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vortex_msgs.msg._waypoints.Waypoints", full_classname_dest, 36) == 0);
  }
  vortex_msgs__msg__Waypoints * ros_message = _ros_message;
  {  // header
...
PyObject * vortex_msgs__msg__waypoints__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vortex_msgs.msg._waypoints");
