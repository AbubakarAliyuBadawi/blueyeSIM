...
class Waypoint_Request(metaclass=Metaclass_Waypoint_Request):
    ...
    _fields_and_field_types = {
        'waypoint': 'sequence<geometry_msgs/Point>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'waypoint' field must be a set or sequence and each value of type 'Point'"
...
class Metaclass_Waypoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vortex_msgs.srv import _waypoint
...
class Waypoint(metaclass=Metaclass_Waypoint):
    from vortex_msgs.srv._waypoint import Waypoint_Request as Request
    from vortex_msgs.srv._waypoint import Waypoint_Response as Response
