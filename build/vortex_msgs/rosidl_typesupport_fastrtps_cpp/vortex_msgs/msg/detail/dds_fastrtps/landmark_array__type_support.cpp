...
#include "vortex_msgs/msg/detail/landmark_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vortex_msgs::msg::Landmark &,
...
cdr_serialize(
  const vortex_msgs::msg::LandmarkArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vortex_msgs::msg::LandmarkArray & ros_message)
{
  // Member: landmarks
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vortex_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Landmark(
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs::msg::LandmarkArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vortex_msgs::msg::LandmarkArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vortex_msgs::msg::LandmarkArray *>(
    untyped_ros_message);
...
{
  return &vortex_msgs::msg::typesupport_fastrtps_cpp::_LandmarkArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vortex_msgs, msg, LandmarkArray)() {
  return &vortex_msgs::msg::typesupport_fastrtps_cpp::_LandmarkArray__handle;
}
