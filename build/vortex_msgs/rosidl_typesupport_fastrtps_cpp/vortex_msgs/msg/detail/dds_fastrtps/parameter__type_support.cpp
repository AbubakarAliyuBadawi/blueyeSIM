...
#include "vortex_msgs/msg/detail/parameter__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vortex_msgs::msg::Parameter & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vortex_msgs::msg::Parameter & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs::msg::Parameter;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vortex_msgs::msg::Parameter *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vortex_msgs::msg::Parameter *>(
    untyped_ros_message);
...
{
  return &vortex_msgs::msg::typesupport_fastrtps_cpp::_Parameter__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vortex_msgs, msg, Parameter)() {
  return &vortex_msgs::msg::typesupport_fastrtps_cpp::_Parameter__handle;
}
