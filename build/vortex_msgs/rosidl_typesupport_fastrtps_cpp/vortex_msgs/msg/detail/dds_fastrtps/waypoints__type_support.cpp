...
#include "vortex_msgs/msg/detail/waypoints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vortex_msgs::msg::Waypoints & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vortex_msgs::msg::Waypoints & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs::msg::Waypoints;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vortex_msgs::msg::Waypoints *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vortex_msgs::msg::Waypoints *>(
    untyped_ros_message);
...
{
  return &vortex_msgs::msg::typesupport_fastrtps_cpp::_Waypoints__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vortex_msgs, msg, Waypoints)() {
  return &vortex_msgs::msg::typesupport_fastrtps_cpp::_Waypoints__handle;
}
