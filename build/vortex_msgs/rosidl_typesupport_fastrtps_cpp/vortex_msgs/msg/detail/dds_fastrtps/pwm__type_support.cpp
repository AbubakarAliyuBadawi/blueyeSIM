...
#include "vortex_msgs/msg/detail/pwm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vortex_msgs::msg::Pwm & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.positive_width_us;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vortex_msgs::msg::Pwm & ros_message)
{
  // Member: pins
  {
    cdr >> ros_message.pins;
  ...
  size_t current_alignment)
{
  ...
  // Member: positive_width_us
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.positive_width_us[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs::msg::Pwm;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vortex_msgs::msg::Pwm *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vortex_msgs::msg::Pwm *>(
    untyped_ros_message);
...
{
  return &vortex_msgs::msg::typesupport_fastrtps_cpp::_Pwm__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vortex_msgs, msg, Pwm)() {
  return &vortex_msgs::msg::typesupport_fastrtps_cpp::_Pwm__handle;
}
