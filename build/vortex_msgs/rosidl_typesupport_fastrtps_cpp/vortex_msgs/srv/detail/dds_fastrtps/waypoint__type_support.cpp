...
#include "vortex_msgs/srv/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  vortex_msgs::srv::Waypoint_Request & ros_message)
{
  // Member: waypoint
  {
    ...
    ros_message.waypoint.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.waypoint[i]);
    }
  }
  ...
  // Member: waypoint
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.waypoint[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs::srv::Waypoint_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vortex_msgs::srv::Waypoint_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vortex_msgs::srv::Waypoint_Request *>(
    untyped_ros_message);
...
{
  return &vortex_msgs::srv::typesupport_fastrtps_cpp::_Waypoint_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vortex_msgs::srv::Waypoint_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vortex_msgs::srv::Waypoint_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<vortex_msgs::srv::Waypoint_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &vortex_msgs::srv::typesupport_fastrtps_cpp::_Waypoint_Response__handle;
}
...
{
  return &vortex_msgs::srv::typesupport_fastrtps_cpp::_Waypoint__handle;
}
