...
static const _DVLAltitude_type_support_symbol_names_t _DVLAltitude_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vortex_msgs, msg, DVLAltitude)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vortex_msgs, msg, DVLAltitude)),
  }
};
...
{
  return &::vortex_msgs::msg::rosidl_typesupport_cpp::DVLAltitude_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vortex_msgs, msg, DVLAltitude)() {
  return get_message_type_support_handle<vortex_msgs::msg::DVLAltitude>();
}
