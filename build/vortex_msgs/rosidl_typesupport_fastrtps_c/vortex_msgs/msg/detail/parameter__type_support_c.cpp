...
#include "vortex_msgs/msg/detail/parameter__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // name, type, value
#include "rosidl_runtime_c/string_functions.h"  // name, type, value

// forward declare type support functions


using _Parameter__ros_msg_type = vortex_msgs__msg__Parameter;
...
static uint32_t _Parameter__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vortex_msgs__msg__Parameter(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs__msg__Parameter;
    is_plain =
      (
...
static size_t _Parameter__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vortex_msgs__msg__Parameter(
