...
#include "vortex_msgs/msg/detail/hybridpath_reference__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose2_d__functions.h"  // eta_d, eta_d_s, eta_d_ss
...
using _HybridpathReference__ros_msg_type = vortex_msgs__msg__HybridpathReference;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _HybridpathReference__ros_msg_type * ros_message = static_cast<const _HybridpathReference__ros_msg_type *>(untyped_ros_message);
  // Field name: w
  {
    cdr << ros_message->w;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _HybridpathReference__ros_msg_type * ros_message = static_cast<_HybridpathReference__ros_msg_type *>(untyped_ros_message);
  // Field name: w
  {
    cdr >> ros_message->w;
  }
...
static uint32_t _HybridpathReference__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vortex_msgs__msg__HybridpathReference(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs__msg__HybridpathReference;
    is_plain =
      (
...
static size_t _HybridpathReference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vortex_msgs__msg__HybridpathReference(
...
static message_type_support_callbacks_t __callbacks_HybridpathReference = {
  "vortex_msgs::msg",
  "HybridpathReference",
...
static rosidl_message_type_support_t _HybridpathReference__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_HybridpathReference,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vortex_msgs, msg, HybridpathReference)() {
  return &_HybridpathReference__type_support;
}
