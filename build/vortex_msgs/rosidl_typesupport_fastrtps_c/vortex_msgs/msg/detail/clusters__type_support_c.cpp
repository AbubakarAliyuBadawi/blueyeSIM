...
#include "vortex_msgs/msg/detail/clusters__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/point_cloud2__functions.h"  // centroids, clusters
...
using _Clusters__ros_msg_type = vortex_msgs__msg__Clusters;
...
size_t get_serialized_size_vortex_msgs__msg__Clusters(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Clusters__ros_msg_type * ros_message = static_cast<const _Clusters__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Clusters__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vortex_msgs__msg__Clusters(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vortex_msgs
size_t max_serialized_size_vortex_msgs__msg__Clusters(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs__msg__Clusters;
    is_plain =
      (
...
static size_t _Clusters__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vortex_msgs__msg__Clusters(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vortex_msgs, msg, Clusters)() {
