...
#include "vortex_msgs/msg/detail/waypoints__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoints__ros_msg_type = vortex_msgs__msg__Waypoints;
...
static uint32_t _Waypoints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vortex_msgs__msg__Waypoints(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs__msg__Waypoints;
    is_plain =
      (
...
static size_t _Waypoints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vortex_msgs__msg__Waypoints(
