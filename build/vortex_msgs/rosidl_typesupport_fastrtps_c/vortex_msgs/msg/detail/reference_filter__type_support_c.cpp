...
#include "vortex_msgs/msg/detail/reference_filter__rosidl_typesupport_fastrtps_c.h"
...
using _ReferenceFilter__ros_msg_type = vortex_msgs__msg__ReferenceFilter;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ReferenceFilter__ros_msg_type * ros_message = static_cast<const _ReferenceFilter__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ReferenceFilter__ros_msg_type * ros_message = static_cast<_ReferenceFilter__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ReferenceFilter__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vortex_msgs__msg__ReferenceFilter(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs__msg__ReferenceFilter;
    is_plain =
      (
...
static size_t _ReferenceFilter__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vortex_msgs__msg__ReferenceFilter(
...
static message_type_support_callbacks_t __callbacks_ReferenceFilter = {
  "vortex_msgs::msg",
  "ReferenceFilter",
...
static rosidl_message_type_support_t _ReferenceFilter__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ReferenceFilter,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vortex_msgs, msg, ReferenceFilter)() {
  return &_ReferenceFilter__type_support;
}
