...
#include "vortex_msgs/srv/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // waypoint
...
using _Waypoint_Request__ros_msg_type = vortex_msgs__srv__Waypoint_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: waypoint
  {
    ...
    size_t size = ros_message->waypoint.size;
    auto array_ptr = ros_message->waypoint.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoint
  {
    ...
    if (ros_message->waypoint.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->waypoint);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->waypoint, size)) {
      fprintf(stderr, "failed to create array for field 'waypoint'");
      return false;
    }
    auto array_ptr = ros_message->waypoint.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_vortex_msgs__srv__Waypoint_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Waypoint_Request__ros_msg_type * ros_message = static_cast<const _Waypoint_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name waypoint
  {
    size_t array_size = ros_message->waypoint.size;
    auto array_ptr = ros_message->waypoint.data;
...
static uint32_t _Waypoint_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vortex_msgs__srv__Waypoint_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vortex_msgs
size_t max_serialized_size_vortex_msgs__srv__Waypoint_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vortex_msgs__srv__Waypoint_Request;
    is_plain =
      (
...
static size_t _Waypoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vortex_msgs__srv__Waypoint_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vortex_msgs, srv, Waypoint_Request)() {
...
using _Waypoint_Response__ros_msg_type = vortex_msgs__srv__Waypoint_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vortex_msgs
size_t get_serialized_size_vortex_msgs__srv__Waypoint_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Waypoint_Response__ros_msg_type * ros_message = static_cast<const _Waypoint_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vortex_msgs__srv__Waypoint_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vortex_msgs
size_t max_serialized_size_vortex_msgs__srv__Waypoint_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vortex_msgs__srv__Waypoint_Response;
    is_plain =
      (
...
static size_t _Waypoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vortex_msgs__srv__Waypoint_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vortex_msgs, srv, Waypoint_Response)() {
...
// already included above
// #include "vortex_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "vortex_msgs/srv/waypoint.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vortex_msgs, srv, Waypoint)() {
