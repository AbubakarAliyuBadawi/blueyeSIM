...
#define NODE_MAIN_LOGGER_NAME "reference_filter_dp_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libreference_filter_dp_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ReferenceFilterNode>";
