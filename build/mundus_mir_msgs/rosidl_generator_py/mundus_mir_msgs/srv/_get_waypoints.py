...
class GetWaypoints_Response(metaclass=Metaclass_GetWaypoints_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.waypoints = kwargs.get('waypoints', str())
    ...
    def waypoints(self, value):
        if __debug__:
            assert \
                ...
                "The 'waypoints' field must be of type 'str'"
...
class Metaclass_GetWaypoints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mundus_mir_msgs.srv.GetWaypoints')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from mundus_mir_msgs.srv import _get_waypoints
...
class GetWaypoints(metaclass=Metaclass_GetWaypoints):
    from mundus_mir_msgs.srv._get_waypoints import GetWaypoints_Request as Request
    from mundus_mir_msgs.srv._get_waypoints import GetWaypoints_Response as Response
