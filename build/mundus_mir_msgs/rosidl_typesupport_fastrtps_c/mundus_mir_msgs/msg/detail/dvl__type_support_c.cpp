...
#include "mundus_mir_msgs/msg/detail/dvl__rosidl_typesupport_fastrtps_c.h"
...
using _DVL__ros_msg_type = mundus_mir_msgs__msg__DVL;
...
size_t get_serialized_size_mundus_mir_msgs__msg__DVL(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DVL__ros_msg_type * ros_message = static_cast<const _DVL__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DVL__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mundus_mir_msgs__msg__DVL(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t max_serialized_size_mundus_mir_msgs__msg__DVL(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs__msg__DVL;
    is_plain =
      (
...
static size_t _DVL__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mundus_mir_msgs__msg__DVL(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, msg, DVL)() {
