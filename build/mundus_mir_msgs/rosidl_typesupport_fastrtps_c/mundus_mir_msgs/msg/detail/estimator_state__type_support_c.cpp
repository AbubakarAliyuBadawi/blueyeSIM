...
#include "mundus_mir_msgs/msg/detail/estimator_state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // bias_accel, bias_ars, position, velocity
...
using _EstimatorState__ros_msg_type = mundus_mir_msgs__msg__EstimatorState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EstimatorState__ros_msg_type * ros_message = static_cast<const _EstimatorState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EstimatorState__ros_msg_type * ros_message = static_cast<_EstimatorState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_mundus_mir_msgs__msg__EstimatorState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EstimatorState__ros_msg_type * ros_message = static_cast<const _EstimatorState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _EstimatorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mundus_mir_msgs__msg__EstimatorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t max_serialized_size_mundus_mir_msgs__msg__EstimatorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs__msg__EstimatorState;
    is_plain =
      (
...
static size_t _EstimatorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mundus_mir_msgs__msg__EstimatorState(
...
static message_type_support_callbacks_t __callbacks_EstimatorState = {
  "mundus_mir_msgs::msg",
  "EstimatorState",
...
static rosidl_message_type_support_t _EstimatorState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EstimatorState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, msg, EstimatorState)() {
  return &_EstimatorState__type_support;
}
