...
#include "mundus_mir_msgs/msg/detail/controller_state__rosidl_typesupport_fastrtps_c.h"
...
using _ControllerState__ros_msg_type = mundus_mir_msgs__msg__ControllerState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bias_ang1
  {
    cdr << ros_message->bias_ang1;
  }

  // Field name: bias_ang2
  {
    cdr << ros_message->bias_ang2;
  }

  // Field name: bias_ang3
  {
    cdr << ros_message->bias_ang3;
  }
...
size_t get_serialized_size_mundus_mir_msgs__msg__ControllerState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControllerState__ros_msg_type * ros_message = static_cast<const _ControllerState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name d6
  {
    size_t item_size = sizeof(ros_message->d6);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name d7
  {
    size_t item_size = sizeof(ros_message->d7);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name d8
  {
    size_t item_size = sizeof(ros_message->d8);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name bias_x
  {
    size_t item_size = sizeof(ros_message->bias_x);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name bias_y
  {
    size_t item_size = sizeof(ros_message->bias_y);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name bias_z
  {
    size_t item_size = sizeof(ros_message->bias_z);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name bias_ang1
  {
    size_t item_size = sizeof(ros_message->bias_ang1);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name bias_ang2
  {
    size_t item_size = sizeof(ros_message->bias_ang2);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name bias_ang3
  {
    size_t item_size = sizeof(ros_message->bias_ang3);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _ControllerState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mundus_mir_msgs__msg__ControllerState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t max_serialized_size_mundus_mir_msgs__msg__ControllerState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs__msg__ControllerState;
    is_plain =
      (
      offsetof(DataType, bias_ang3) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ControllerState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mundus_mir_msgs__msg__ControllerState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, msg, ControllerState)() {
