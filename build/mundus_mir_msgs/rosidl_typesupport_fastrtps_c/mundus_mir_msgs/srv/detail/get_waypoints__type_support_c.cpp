...
#include "mundus_mir_msgs/srv/detail/get_waypoints__rosidl_typesupport_fastrtps_c.h"
...
using _GetWaypoints_Request__ros_msg_type = mundus_mir_msgs__srv__GetWaypoints_Request;
...
size_t get_serialized_size_mundus_mir_msgs__srv__GetWaypoints_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetWaypoints_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mundus_mir_msgs__srv__GetWaypoints_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t max_serialized_size_mundus_mir_msgs__srv__GetWaypoints_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs__srv__GetWaypoints_Request;
    is_plain =
      (
...
static size_t _GetWaypoints_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mundus_mir_msgs__srv__GetWaypoints_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, GetWaypoints_Request)() {
...
using _GetWaypoints_Response__ros_msg_type = mundus_mir_msgs__srv__GetWaypoints_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->waypoints;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoints
  {
    ...
    if (!ros_message->waypoints.data) {
      rosidl_runtime_c__String__init(&ros_message->waypoints);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t get_serialized_size_mundus_mir_msgs__srv__GetWaypoints_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetWaypoints_Response__ros_msg_type * ros_message = static_cast<const _GetWaypoints_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mundus_mir_msgs__srv__GetWaypoints_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t max_serialized_size_mundus_mir_msgs__srv__GetWaypoints_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mundus_mir_msgs__srv__GetWaypoints_Response;
    is_plain =
      (
...
static size_t _GetWaypoints_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mundus_mir_msgs__srv__GetWaypoints_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, GetWaypoints_Response)() {
...
// already included above
// #include "mundus_mir_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "mundus_mir_msgs/srv/get_waypoints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, GetWaypoints)() {
