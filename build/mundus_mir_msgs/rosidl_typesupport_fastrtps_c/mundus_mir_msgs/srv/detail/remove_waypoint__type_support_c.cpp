...
#include "mundus_mir_msgs/srv/detail/remove_waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _RemoveWaypoint_Request__ros_msg_type = mundus_mir_msgs__srv__RemoveWaypoint_Request;
...
size_t get_serialized_size_mundus_mir_msgs__srv__RemoveWaypoint_Request(
  const void * untyped_ros_message,
...
static uint32_t _RemoveWaypoint_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mundus_mir_msgs__srv__RemoveWaypoint_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t max_serialized_size_mundus_mir_msgs__srv__RemoveWaypoint_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs__srv__RemoveWaypoint_Request;
    is_plain =
      (
...
static size_t _RemoveWaypoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mundus_mir_msgs__srv__RemoveWaypoint_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, RemoveWaypoint_Request)() {
...
using _RemoveWaypoint_Response__ros_msg_type = mundus_mir_msgs__srv__RemoveWaypoint_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t get_serialized_size_mundus_mir_msgs__srv__RemoveWaypoint_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RemoveWaypoint_Response__ros_msg_type * ros_message = static_cast<const _RemoveWaypoint_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mundus_mir_msgs__srv__RemoveWaypoint_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mundus_mir_msgs
size_t max_serialized_size_mundus_mir_msgs__srv__RemoveWaypoint_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mundus_mir_msgs__srv__RemoveWaypoint_Response;
    is_plain =
      (
...
static size_t _RemoveWaypoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mundus_mir_msgs__srv__RemoveWaypoint_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, RemoveWaypoint_Response)() {
...
// already included above
// #include "mundus_mir_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "mundus_mir_msgs/srv/remove_waypoint.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, RemoveWaypoint)() {
