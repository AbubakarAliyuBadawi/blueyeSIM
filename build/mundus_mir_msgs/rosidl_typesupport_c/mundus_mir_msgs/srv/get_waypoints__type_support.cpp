...
static const _GetWaypoints_Request_type_support_symbol_names_t _GetWaypoints_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, GetWaypoints_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mundus_mir_msgs, srv, GetWaypoints_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mundus_mir_msgs, srv, GetWaypoints_Request)() {
  return &::mundus_mir_msgs::srv::rosidl_typesupport_c::GetWaypoints_Request_message_type_support_handle;
}
...
static const _GetWaypoints_Response_type_support_symbol_names_t _GetWaypoints_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, GetWaypoints_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mundus_mir_msgs, srv, GetWaypoints_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mundus_mir_msgs, srv, GetWaypoints_Response)() {
  return &::mundus_mir_msgs::srv::rosidl_typesupport_c::GetWaypoints_Response_message_type_support_handle;
}
...
static const _GetWaypoints_type_support_symbol_names_t _GetWaypoints_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, GetWaypoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mundus_mir_msgs, srv, GetWaypoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mundus_mir_msgs, srv, GetWaypoints)() {
  return &::mundus_mir_msgs::srv::rosidl_typesupport_c::GetWaypoints_service_type_support_handle;
}
