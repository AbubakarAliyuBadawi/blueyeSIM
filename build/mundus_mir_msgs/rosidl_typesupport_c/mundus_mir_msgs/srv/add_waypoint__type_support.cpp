...
static const _AddWaypoint_Request_type_support_symbol_names_t _AddWaypoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, AddWaypoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mundus_mir_msgs, srv, AddWaypoint_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mundus_mir_msgs, srv, AddWaypoint_Request)() {
  return &::mundus_mir_msgs::srv::rosidl_typesupport_c::AddWaypoint_Request_message_type_support_handle;
}
...
static const _AddWaypoint_Response_type_support_symbol_names_t _AddWaypoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, AddWaypoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mundus_mir_msgs, srv, AddWaypoint_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mundus_mir_msgs, srv, AddWaypoint_Response)() {
  return &::mundus_mir_msgs::srv::rosidl_typesupport_c::AddWaypoint_Response_message_type_support_handle;
}
...
static const _AddWaypoint_type_support_symbol_names_t _AddWaypoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, srv, AddWaypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mundus_mir_msgs, srv, AddWaypoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mundus_mir_msgs, srv, AddWaypoint)() {
  return &::mundus_mir_msgs::srv::rosidl_typesupport_c::AddWaypoint_service_type_support_handle;
}
