...
static const _ReturnRecommendation_type_support_symbol_names_t _ReturnRecommendation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mundus_mir_msgs, msg, ReturnRecommendation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mundus_mir_msgs, msg, ReturnRecommendation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mundus_mir_msgs, msg, ReturnRecommendation)() {
  return &::mundus_mir_msgs::msg::rosidl_typesupport_c::ReturnRecommendation_message_type_support_handle;
}
