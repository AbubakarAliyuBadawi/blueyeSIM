...
#include "mundus_mir_msgs/srv/detail/get_waypoints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mundus_mir_msgs::srv::GetWaypoints_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mundus_mir_msgs::srv::GetWaypoints_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs::srv::GetWaypoints_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::srv::GetWaypoints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mundus_mir_msgs::srv::GetWaypoints_Request *>(
    untyped_ros_message);
...
{
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mundus_mir_msgs, srv, GetWaypoints_Request)() {
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mundus_mir_msgs
cdr_serialize(
  const mundus_mir_msgs::srv::GetWaypoints_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mundus_mir_msgs::srv::GetWaypoints_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mundus_mir_msgs::srv::GetWaypoints_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::srv::GetWaypoints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mundus_mir_msgs::srv::GetWaypoints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mundus_mir_msgs, srv, GetWaypoints_Response)() {
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints_Response__handle;
}
...
{
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mundus_mir_msgs, srv, GetWaypoints)() {
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints__handle;
}
