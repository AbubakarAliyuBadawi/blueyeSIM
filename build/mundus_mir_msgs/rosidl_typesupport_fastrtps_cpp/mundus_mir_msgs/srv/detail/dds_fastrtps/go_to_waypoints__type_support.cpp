...
#include "mundus_mir_msgs/srv/detail/go_to_waypoints__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs::srv::GoToWaypoints_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::srv::GoToWaypoints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mundus_mir_msgs::srv::GoToWaypoints_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GoToWaypoints_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::srv::GoToWaypoints_Request *>(
...
static size_t _GoToWaypoints_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GoToWaypoints_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GoToWaypoints_Request__callbacks = {
  "mundus_mir_msgs::srv",
...
static rosidl_message_type_support_t _GoToWaypoints_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GoToWaypoints_Request__callbacks,
...
{
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GoToWaypoints_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mundus_mir_msgs::srv::GoToWaypoints_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::srv::GoToWaypoints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mundus_mir_msgs::srv::GoToWaypoints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GoToWaypoints_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::srv::GoToWaypoints_Response *>(
...
static size_t _GoToWaypoints_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GoToWaypoints_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GoToWaypoints_Response__callbacks = {
  "mundus_mir_msgs::srv",
...
static rosidl_message_type_support_t _GoToWaypoints_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GoToWaypoints_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GoToWaypoints_Response__handle;
}
...
static service_type_support_callbacks_t _GoToWaypoints__callbacks = {
  "mundus_mir_msgs::srv",
  "GoToWaypoints",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mundus_mir_msgs, srv, GoToWaypoints_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mundus_mir_msgs, srv, GoToWaypoints_Response)(),
...
static rosidl_service_type_support_t _GoToWaypoints__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GoToWaypoints__callbacks,
...
{
  return &mundus_mir_msgs::srv::typesupport_fastrtps_cpp::_GoToWaypoints__handle;
}
