...
#include "mundus_mir_msgs/msg/detail/dvl__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mundus_mir_msgs::msg::DVL & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mundus_mir_msgs::msg::DVL & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs::msg::DVL;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::msg::DVL *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mundus_mir_msgs::msg::DVL *>(
    untyped_ros_message);
...
{
  return &mundus_mir_msgs::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mundus_mir_msgs, msg, DVL)() {
  return &mundus_mir_msgs::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
