...
#include "mundus_mir_msgs/msg/detail/controller_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mundus_mir_msgs::msg::ControllerState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mundus_mir_msgs::msg::ControllerState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs::msg::ControllerState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::msg::ControllerState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mundus_mir_msgs::msg::ControllerState *>(
    untyped_ros_message);
...
get_message_type_support_handle<mundus_mir_msgs::msg::ControllerState>()
{
  return &mundus_mir_msgs::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mundus_mir_msgs, msg, ControllerState)() {
  return &mundus_mir_msgs::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
