...
#include "mundus_mir_msgs/msg/detail/reference__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mundus_mir_msgs::msg::Reference & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mundus_mir_msgs::msg::Reference & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mundus_mir_msgs::msg::Reference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mundus_mir_msgs::msg::Reference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mundus_mir_msgs::msg::Reference *>(
    untyped_ros_message);
...
static size_t _Reference__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Reference(full_bounded, is_plain, 0);
...
get_message_type_support_handle<mundus_mir_msgs::msg::Reference>()
{
  return &mundus_mir_msgs::msg::typesupport_fastrtps_cpp::_Reference__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mundus_mir_msgs, msg, Reference)() {
  return &mundus_mir_msgs::msg::typesupport_fastrtps_cpp::_Reference__handle;
}
