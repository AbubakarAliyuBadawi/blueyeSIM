...
#define NODE_MAIN_LOGGER_NAME "thrust_allocator_auv_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libthrust_allocator_auv_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ThrustAllocator>";
