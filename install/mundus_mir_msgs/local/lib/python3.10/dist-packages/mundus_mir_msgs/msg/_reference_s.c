...
bool mundus_mir_msgs__msg__reference__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mundus_mir_msgs.msg._reference.Reference", full_classname_dest, 40) == 0);
  }
  mundus_mir_msgs__msg__Reference * ros_message = _ros_message;
  {  // header
...
PyObject * mundus_mir_msgs__msg__reference__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mundus_mir_msgs.msg._reference");
