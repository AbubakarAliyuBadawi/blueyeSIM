...
bool mundus_mir_msgs__msg__blueye_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mundus_mir_msgs.msg._blueye_command.BlueyeCommand", full_classname_dest, 49) == 0);
  }
  mundus_mir_msgs__msg__BlueyeCommand * ros_message = _ros_message;
  {  // surge
...
{
  /* NOTE(esteve): Call constructor of BlueyeCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mundus_mir_msgs.msg._blueye_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BlueyeCommand");
