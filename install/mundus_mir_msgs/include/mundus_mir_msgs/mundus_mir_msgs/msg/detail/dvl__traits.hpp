...
#ifndef MUNDUS_MIR_MSGS__MSG__DETAIL__DVL__TRAITS_HPP_
#define MUNDUS_MIR_MSGS__MSG__DETAIL__DVL__TRAITS_HPP_
...
inline void to_yaml(
  const mundus_mir_msgs::msg::DVL & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mundus_mir_msgs::msg::DVL & msg)
{
  return mundus_mir_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<mundus_mir_msgs::msg::DVL>()
{
  return "mundus_mir_msgs::msg::DVL";
}

template<>
inline const char * name<mundus_mir_msgs::msg::DVL>()
{
  return "mundus_mir_msgs/msg/DVL";
}

template<>
struct has_fixed_size<mundus_mir_msgs::msg::DVL>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Vector3>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<mundus_mir_msgs::msg::DVL>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Vector3>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<mundus_mir_msgs::msg::DVL>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MUNDUS_MIR_MSGS__MSG__DETAIL__DVL__TRAITS_HPP_
