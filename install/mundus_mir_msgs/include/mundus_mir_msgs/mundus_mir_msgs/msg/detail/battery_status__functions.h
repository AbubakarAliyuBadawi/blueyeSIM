...
#ifndef MUNDUS_MIR_MSGS__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_
#define MUNDUS_MIR_MSGS__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_
 ...
 * calls
 * mundus_mir_msgs__msg__BatteryStatus__init().
...
/**
 * It calls
 * mundus_mir_msgs__msg__BatteryStatus__fini()
 ...
 * mundus_mir_msgs__msg__BatteryStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mundus_mir_msgs__msg__BatteryStatus__Sequence__fini()
 * on the array,
...
#endif  // MUNDUS_MIR_MSGS__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_
