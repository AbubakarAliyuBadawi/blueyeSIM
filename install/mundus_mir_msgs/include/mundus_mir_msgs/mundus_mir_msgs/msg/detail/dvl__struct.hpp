...
#ifndef MUNDUS_MIR_MSGS__MSG__DETAIL__DVL__STRUCT_HPP_
#define MUNDUS_MIR_MSGS__MSG__DETAIL__DVL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__mundus_mir_msgs__msg__DVL __attribute__((deprecated))
#else
# define DEPRECATED__mundus_mir_msgs__msg__DVL __declspec(deprecated)
#endif
...
struct DVL_
{
  ...
  // pointer types
  using RawPtr =
    mundus_mir_msgs::msg::DVL_<ContainerAllocator> *;
  using ConstRawPtr =
    const mundus_mir_msgs::msg::DVL_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mundus_mir_msgs::msg::DVL_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mundus_mir_msgs::msg::DVL_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mundus_mir_msgs::msg::DVL_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mundus_mir_msgs::msg::DVL_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mundus_mir_msgs::msg::DVL_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mundus_mir_msgs::msg::DVL_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mundus_mir_msgs::msg::DVL_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mundus_mir_msgs__msg__DVL
    std::shared_ptr<mundus_mir_msgs::msg::DVL_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mundus_mir_msgs__msg__DVL
    std::shared_ptr<mundus_mir_msgs::msg::DVL_<ContainerAllocator> const>
...
using DVL =
  mundus_mir_msgs::msg::DVL_<std::allocator<void>>;
...
#endif  // MUNDUS_MIR_MSGS__MSG__DETAIL__DVL__STRUCT_HPP_
